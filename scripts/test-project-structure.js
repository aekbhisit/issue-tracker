...
const payload = {
  ...
  "title":"TEST PROJECT STRUCTURE - " + Date.now(),
  "description":"Testing new project-based storage structure",
  "severity":"medium",
  "metadata":{
  ...
  "screenshot":{
    ...
    "selector":{
      "cssSelector":"div.project-structure-test",
      "xpath":"/html/body/div[1]",
      "boundingBox":{"x":10,"y":20,"width":100,"height":50},
      "outerHTML":"<div class=\"project-structure-test\">Test</div>"
    }
  }
};

console.log('Testing project-based storage structure...');
